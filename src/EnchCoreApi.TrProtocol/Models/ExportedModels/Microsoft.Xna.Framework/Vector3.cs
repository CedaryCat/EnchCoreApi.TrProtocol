...
public struct Vector3 : IEquatable<Vector3>, ISoildSerializableData {
    ...
    public static Vector3 _zero = default(Vector3);

    public static Vector3 _one = new Vector3(1f, 1f, 1f);

    public static Vector3 _unitX = new Vector3(1f, 0f, 0f);

    public static Vector3 _unitY = new Vector3(0f, 1f, 0f);

    public static Vector3 _unitZ = new Vector3(0f, 0f, 1f);

    public static Vector3 _up = new Vector3(0f, 1f, 0f);

    public static Vector3 _down = new Vector3(0f, -1f, 0f);

    public static Vector3 _right = new Vector3(1f, 0f, 0f);

    public static Vector3 _left = new Vector3(-1f, 0f, 0f);

    public static Vector3 _forward = new Vector3(0f, 0f, -1f);

    public static Vector3 _backward = new Vector3(0f, 0f, 1f);
