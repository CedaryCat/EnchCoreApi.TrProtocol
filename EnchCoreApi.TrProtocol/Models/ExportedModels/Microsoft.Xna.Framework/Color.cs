...
namespace Microsoft.Xna.Framework {
    ...
    public struct Color : IPackedVector<uint>, IPackedVector, IEquatable<Color>, ISequentialSerializableData<SequentialColor> {
        public unsafe SequentialColor SequentialData {
            get {
                fixed (void* ptr = &packedValue){
                    return Unsafe.Read<SequentialColor>(ptr);
                }
            }
            set {
                packedValue = 0;
        ...
        public static int ClampToByte32(int value) {
            if (value < 0)
                return 0;
            if (value > 255)
                return 255;
        ...
        public static int ClampToByte64(long value) {
            if (value < 0)
                return 0;
            if (value > 255)
                return 255;
        ...
        public Vector3 ToVector3() {
            ...
            result.X = UnpackUNorm(255u, packedValue);
            result.Y = UnpackUNorm(255u, packedValue >> 8);
            result.Z = UnpackUNorm(255u, packedValue >> 16);
            return result;
        }
        ...
        public Vector4 ToVector4() {
            ...
            result.Y = UnpackUNorm(255u, packedValue >> 8);
            result.Z = UnpackUNorm(255u, packedValue >> 16);
            result.W = UnpackUNorm(255u, packedValue >> 24);
            return result;
        }
